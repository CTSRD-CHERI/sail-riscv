...
bool rv_enable_pbmt = false;
bool rv_enable_sdext = false;
bool rv_enable_sdtrig = false;
bool rv_enable_smclic = false;
bool rv_enable_smclicconfig = false;
bool rv_enable_smclicshv = false;
bool rv_enable_ssclic = false;
bool rv_enable_sstc = false;
bool rv_enable_sv32 = false;
bool rv_enable_sv39 = false;
bool rv_enable_sv48 = false;
bool rv_enable_sv57 = false;
bool rv_enable_svnapot = false;
bool rv_enable_zba = false;
bool rv_enable_zbb = false;
bool rv_enable_zbc = false;
bool rv_enable_zbs = false;
bool rv_enable_zfh = false;
bool rv_enable_zfhmin = false;
bool rv_enable_zkn = false;
bool rv_enable_zkr = false;
bool rv_enable_zks = false;
